...
var Modal = React6.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react4.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react4.useState)(false);
  const waitingForMouseUpRef = (0, import_react4.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react4.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react4.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react4.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react4.useCallback)((backdropProps) => (0, import_jsx_runtime6.jsx)("div", {
    ...backdropProps,
