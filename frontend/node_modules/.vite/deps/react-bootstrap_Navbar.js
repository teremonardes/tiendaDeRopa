...
import {
  ...
  useEventCallback
} from "./chunk-XNZKYQQU.js";
import "./chunk-PXOQPXOC.js";
import "./chunk-3T62ZRKQ.js";
import "./chunk-T37TWCKW.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-SKO4YJXT.js";
import {
  require_jsx_runtime
...
var OffcanvasBody = React5.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React6.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var OffcanvasHeader = React7.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React8.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React9.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = (0, import_react7.useState)(false);
  ...
  const renderBackdrop = (0, import_react7.useCallback)((backdropProps) => (0, import_jsx_runtime9.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React10.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context = (0, import_react8.useContext)(NavbarContext_default);
...
var NavbarText = React11.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React12.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react9.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react9.useMemo)(() => ({
